...
echo "Downloading fruit fly genome dm6 (BDGP6.54 release 115 from Ensembl)"

mkdir -p dm6-ensembl-115
rm -rf dm6-ensembl-115/*
cd dm6-ensembl-115
...
python "${filter_path}/filter-chromosome.py" \
  ...
  Drosophila_melanogaster.BDGP6.54.dna.toplevel.fa \
  Drosophila_melanogaster.BDGP6.54.dna.toplevel.filtered.fa
...
python "${filter_path}/filter-chromosome.py" \
  ...
  Drosophila_melanogaster.BDGP6.54.115.filtered.gtf
python "${replace_path}/replace-chromosome.py" --delete \
  --mapping chromAlias.txt \
  Drosophila_melanogaster.BDGP6.54.115.filtered.gtf \
  dm6.gtf

rm Drosophila_melanogaster.BDGP6.54.dna.toplevel.fa
rm Drosophila_melanogaster.BDGP6.54.dna.toplevel.filtered.fa
